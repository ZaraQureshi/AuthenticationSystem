...
import { registerUser, ping, loginUser, refreshToken, forgotPassword, resetPassword, purgeExpiredTokens, logout, onboardUser, verifyEmail } from '../src/contoller';
...
routes.post('/confirm-email', verifyEmail);
